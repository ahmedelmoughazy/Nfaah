...
//        container.backgroundColor = Asset.Colors.indicatorBackgroundColor.color.withAlphaComponent(0.5)
...
//        activityIndicator.color = Asset.Colors.loginBtnBackground.color
